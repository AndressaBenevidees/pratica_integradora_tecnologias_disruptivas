...
const initialRows = [
  createData(1, 'Tarefa 1', 'Descrição da Tarefa 1', '2024-11-01', '2024-11-02', 'Concluída', 'Recurso 1'),
  createData(2, 'Tarefa 2', 'Descrição da Tarefa 2', '2024-11-03', '2024-11-04', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Tarefa 3', 'Descrição da Tarefa 3', '2024-11-04', '2024-11-05', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Tarefa 4', 'Descrição da Tarefa 4', '2024-11-05', '2024-11-06', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Tarefa 5', 'Descrição da Tarefa 5', '2024-11-06', '2024-11-07', 'Em Andamento', 'Recurso 5'),
  createData(6, 'Tarefa 6', 'Descrição da Tarefa 6', '2024-11-07', '2024-11-08', 'Aguardando', 'Recurso 6'),
];
